...
// defaultClusterDomain is the Kubernetes cluster DNS suffix when
// raft.cluster_domain is unset.
...
// dnsPeerResolver derives peers from <sts>-<i>.<headless>.<ns>.svc.<clusterDomain>.
